...
class Model(object):
    # config is the config variable
    # batch is the data. data is managed by some tf object that's passed a manual parser,
    #   look at util.py
    # word_mat is preprocessed w2v stuff i think
    # char_mat is preprocessed w2v stuff i think
    # trainable, can this be trained. false if testing
    # opt
